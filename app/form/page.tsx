    ...
    switch (language) {
      case "de":
        return {
          ...
          subtitle:
            "Teilen Sie Ihre Vision mit uns und wir verwandeln sie in eine professionelle, leistungsstarke Website, die Ergebnisse liefert.",
          features: [
      ...
      case "fa":
        return {
          ...
          subtitle:
            "ایده خود را با ما در میان بگذارید و ما آن را به وب‌سایتی حرفه‌ای و قدرتمند تبدیل می‌کنیم که نتیجه‌ای عالی دارد.",
          features: [
            "مشاوره حرفه‌ای",
            "راه‌حل‌های سفارشی",
            "اجرای سریع",
      ...
      case "tr":
        return {
          ...
          subtitle:
            "Vizyonunuzu bizimle paylaşın, biz de onu sonuç getiren profesyonel, güçlü bir web sitesine dönüştürelim.",
          features: [
      ...
      default:
        return {
          ...
          subtitle:
            "Share your vision with us and we'll transform it into a professional, powerful website that delivers results.",
          features: [
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-8 max-w-md mx-4 text-center">
            ...
            <p className="text-gray-600">
              ...
              {language === "de" &&
                "Ihre Anfrage wurde erfolgreich übermittelt. Wir werden uns bald bei Ihnen melden!"}
              {language === "fa" &&
                "درخواست شما با موفقیت ارسال شد. به زودی با شما تماس خواهیم گرفت!"}
              {language === "tr" &&
                "Talebiniz başarıyla gönderildi. Yakında sizinle iletişime geçeceğiz!"}
            </p>
          </div>
        </div>
      )}
      ...
      <section className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            ...
            {language === "de" &&
              "Warum unseren Website-Entwicklungsservice wählen?"}
            {language === "fa" && "چرا خدمات توسعه وب‌سایت ما را انتخاب کنید؟"}
            {language === "tr" &&
              "Neden Web Sitesi Geliştirme Hizmetimizi Seçmelisiniz?"}
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                {language === "en" &&
                  "We deliver high-quality websites quickly without compromising on quality."}
                {language === "de" &&
                  "Wir liefern hochwertige Websites schnell, ohne Kompromisse bei der Qualität."}
                {language === "fa" &&
                  "ما وب‌سایت‌های با کیفیت بالا را بدون به خطر انداختن کیفیت سریع تحویل می‌دهیم."}
                {language === "tr" &&
                  "Kaliteden ödün vermeden hızlı bir şekilde yüksek kaliteli web siteleri sunuyoruz."}
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                ...
                {language === "de" &&
                  "Erstellt mit Sicherheits-Best-Practices und zuverlässiger Hosting-Infrastruktur."}
                {language === "fa" &&
                  "با بهترین روش‌های امنیتی و زیرساخت میزبانی قابل اعتماد ساخته شده."}
                {language === "tr" &&
                  "Güvenlik en iyi uygulamaları ve güvenilir hosting altyapısı ile oluşturulmuştur."}
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                ...
                {language === "de" &&
                  "Wir bieten kontinuierlichen Support und Wartung, um Ihre Website reibungslos am Laufen zu halten."}
                {language === "fa" &&
                  "ما پشتیبانی و نگهداری مداوم ارائه می‌دهیم تا وب‌سایت شما به روانی کار کند."}
                {language === "tr" &&
                  "Web sitenizin sorunsuz çalışmasını sağlamak için sürekli destek ve bakım sağlıyoruz."}
              </p>
            </div>
          </div>
        </div>
