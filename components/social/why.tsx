...
const WhyChooseUs = () => {
  ...
  return (
    <div className="py-20 bg-white w-full overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 box-border w-full">
        <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
          {/* Left Side - Visual Element */}
          <div className="lg:col-span-5 mb-12 lg:mb-0">
            <div className="relative">
              {/* Main Image/Graphic */}
              <div className="bg-gradient-to-br from-blue-900 to-blue-700 rounded-xl p-4 sm:p-8 shadow-xl relative z-10 overflow-hidden">
                <div className="text-white text-lg font-semibold mb-4 break-words">Emoviral sorgt für Ihren Erfolg</div>
                ...
                <div className="space-y-4">
                  {benefits.map((benefit, index) => (
                    <div key={index} className="flex items-center gap-3 bg-white text-black bg-opacity-10 p-3 rounded">
                      ...
                      <span className="break-words">{benefit.title}</span>
                    </div>
                  ))}
                </div>
                
                <div className="mt-8 text-white text-center p-2 sm:p-4 border border-white border-opacity-20 rounded-lg">
                  <div className="font-bold text-xl mb-2 break-words">Emoviral</div>
                  <div className="text-sm break-words">Ihr Partner für erfolgreiches Social-Media-Management</div>
                </div>
              </div>
              
              {/* Decorative elements - adjusted for mobile */}
              <div className="absolute -top-6 -right-6 w-16 sm:w-32 h-16 sm:h-32 bg-yellow-400 rounded-lg -z-0 opacity-70"></div>
              <div className="absolute -bottom-6 -left-6 w-16 sm:w-24 h-16 sm:h-24 bg-red-700 rounded-full -z-0 opacity-70"></div>
            </div>
          </div>
          
          {/* Right Side - Content */}
          <div className="lg:col-span-7">
            <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-6 break-words">
            ...
            <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex flex-col items-center md:items-start text-center md:text-left">
                  ...
                  <h3 className="text-xl font-semibold text-blue-900 mb-2 break-words">
                    {benefit.title}
                  </h3>
            ...
            <div className="mt-12 p-4 sm:p-6 bg-gray-50 rounded-lg border border-gray-100 shadow-sm">
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="bg-yellow-400 p-2 rounded-full flex-shrink-0">
                  <Check className="w-6 h-6 text-blue-900" />
                </div>
                <div className="min-w-0">
                  <h4 className="text-lg font-semibold text-blue-900 mb-2 break-words">100% auf Ihre Bedürfnisse zugeschnitten</h4>
                  <p className="text-gray-600">
